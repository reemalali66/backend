...
@CrossOrigin(origins = "*")
 public class StoreReview {
    ...
    public String storeData(@RequestBody String request) throws IOException{
        ...
        jdbc.execute("INSERT INTO `sys`.`movie_reviews` (`name`, `review`) VALUES ('"+username+"','"+UserReview+"');");
    ...
    public List<Movie> getItems() throws IOException{
        List<Movie> items = jdbc.query("SELECT * FROM `sys`.`movie_list`", new MovieMapper());
        return items;
    }
